        ...
        <div class="jumbotron">
            ...
            if(isset($studentloginemail)){
                ...
                c.course_desc,c.course_img,c.course_author,c.course_original_price,c.course_price
                 FROM courseorder AS co JOIN course AS c ON c.course_id=co.course_id WHERE
                  co.student_email='$studentloginemail'";
                      ...
                      <div class="col-sm-6 mb-3">
                          <div class="card-body">
                            ...
                            <p class="card-text d-inline"> Price: <small>
                                <del>&#8377 <?php echo $row['course_original_price'] ?> </del></small>
